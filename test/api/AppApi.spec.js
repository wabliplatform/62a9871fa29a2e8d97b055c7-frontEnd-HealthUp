...
(function(root, factory) {
  ...
  describe('AppApi', function() {
    ...
    describe('getAllapp', function() {
      it('should call getAllapp successfully', function(done) {
        //uncomment below and update the code to test getAllapp
        //instance.getAllapp(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
